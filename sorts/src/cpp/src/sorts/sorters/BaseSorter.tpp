...
template <class T> inline bool Sorter<T>::is_sorted() const noexcept { return is_sorted_; }

template <class T> inline SharedPtr<SmartPtrLinkedListSequence<T>> Sorter<T>::get_interesting_indexes() const noexcept {
  return interesting_indexes_;
}

template <class T> inline u_int32_t Sorter<T>::get_comparisons() const noexcept { return comparisons_; }

template <class T> inline u_int32_t Sorter<T>::get_swaps() const noexcept { return swaps_; }

template <class T> u_int32_t kogan::Sorter<T>::get_available_steps() const noexcept { return available_steps_; }

template <class T> inline bool kogan::Sorter<T>::is_limited() const noexcept { return limited_; }

template <class T> inline void kogan::Sorter<T>::add_available_steps(u_int32_t available_steps) noexcept {
