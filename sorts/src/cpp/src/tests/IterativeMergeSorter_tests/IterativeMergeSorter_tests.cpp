...
TEST(random, iterative_merge_sorter_test_suite) {
  ...
  kogan::IterativeMergeSorter<int> sorter([](int a, int b) { return a - b; }, sequence);
...
kogan::TestSuite get_iterative_merge_sorter_test_suite() { return iterative_merge_sorter_test_suite; }