...
template <class T> inline void SmartPtrLinkedList<T>::append(T value) noexcept {
...
template <class T> inline void SmartPtrLinkedList<T>::clear() noexcept {
  root_->head = nullptr;
  root_->tail = nullptr;
  length_ = 0;
}
...
template <class T> inline void SmartPtrLinkedList<T>::init_() {
