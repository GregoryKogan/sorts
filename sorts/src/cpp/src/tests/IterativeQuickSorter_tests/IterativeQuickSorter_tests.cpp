...
TEST(random, iterative_quick_sorter_test_suite) {
  ...
  kogan::IterativeQuickSorter<int> sorter([](int a, int b) { return a - b; },
                                          sequence);
...
kogan::TestSuite get_iterative_quick_sorter_test_suite() {
  return iterative_quick_sorter_test_suite;
}