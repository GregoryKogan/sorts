...
template <class T> inline SmartPtrArraySequence<T>::SmartPtrArraySequence(SharedPtr<T[]> items, int count) {
  array = make_unique<SmartPtrDynamicArray<T>>(items, count);
}

template <class T> SmartPtrArraySequence<T>::SmartPtrArraySequence() { array = make_unique<SmartPtrDynamicArray<T>>(); }

template <class T> SmartPtrArraySequence<T>::SmartPtrArraySequence(const SmartPtrArraySequence<T> &arraySequence) {
  array = make_unique<SmartPtrDynamicArray<T>>(*arraySequence.array);
}

template <class T> T SmartPtrArraySequence<T>::get_first() const { return get(0); }

template <class T> T SmartPtrArraySequence<T>::get_last() const { return get(get_length() - 1); }

template <class T> T SmartPtrArraySequence<T>::get(int index) const { return array->get(index); }

template <class T>
UniquePtr<SmartPtrSequence<T>> SmartPtrArraySequence<T>::get_subsequence(int start_index, int end_index) const {
  if (start_index < 0 || start_index >= get_length()) throw IndexOutOfRangeException(start_index, 0, get_length() - 1);
...
template <class T> size_t SmartPtrArraySequence<T>::get_length() const { return array->get_length(); }

template <class T> void SmartPtrArraySequence<T>::set(int index, T item) { array->set(index, item); }

template <class T> void SmartPtrArraySequence<T>::append(T item) {
...
template <class T> void SmartPtrArraySequence<T>::insert(int index, T item) {
...
template <class T> void SmartPtrArraySequence<T>::clear() { array->resize(0); }

template <class T> void SmartPtrArraySequence<T>::remove(int index) {
...
template <class T> T &SmartPtrArraySequence<T>::operator[](int index) { return array->operator[](index); }
