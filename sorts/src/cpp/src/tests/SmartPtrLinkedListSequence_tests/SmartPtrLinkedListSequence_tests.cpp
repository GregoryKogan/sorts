...
kogan::TestSuite
    smart_ptr_linked_list_sequence_test_suite("SmartPtrLinkedListSequence");
...
TEST(concat_empty_head, smart_ptr_linked_list_sequence_test_suite) {
  ...
  kogan::SharedPtr<kogan::SmartPtrSequence<int>> seq_empty =
      kogan::SharedPtr<kogan::SmartPtrSequence<int>>(
          new kogan::SmartPtrLinkedListSequence<int>());
  kogan::UniquePtr<kogan::SmartPtrSequence<int>> cone2 =
      seq_empty->concat(seq2);
...
TEST(remove_empty_IndexOutOfRangeException,
     smart_ptr_linked_list_sequence_test_suite) {
  kogan::SmartPtrLinkedListSequence<int> seq;
...
kogan::TestSuite get_smart_ptr_linked_list_sequence_test_suite() {
  return smart_ptr_linked_list_sequence_test_suite;
}